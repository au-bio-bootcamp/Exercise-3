...
# 20101020 JDW - Fix bug from Perl limitation in minimum repeat count
#		 in pattern > 32K? when finding longest run of
#		 non-ACGT (or N) bases.
#
$Date_Last_Modified = "October 20, 2010";
...
$MAX_PATTERN_MIN_RPT = 32000;	# Address Perl limitation of minimum
				#   repeat count in a pattern
...
####use lib '/home/shared/biobootcamp/bin/lib/perl5';
use Getopt::Std;
